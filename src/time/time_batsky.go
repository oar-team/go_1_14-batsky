...
func now_batsky() (sec int64, nsec int32, mono int64) {
	tv := C.gettimeofday_batsky()
	return int64(tv.tv_sec), int32(1000 * tv.tv_usec), int64(tv.tv_sec) * 1e9 + int64(1000 * tv.tv_usec) 
}
